      ...
      {[...Array(5)].map((_, i) => (
        ...
        >
          <div className="flex items-center flex-1 gap-3 w-full">
            <div className="w-8 h-8 bg-card rounded-lg shrink-0"></div>
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto justify-between">
            <div className="h-8 w-32 bg-background-muted rounded-lg"></div>
            <div className="h-8 w-24 bg-background-muted rounded-lg"></div> 
          </div>
        </div>
      ))}
    </div>
