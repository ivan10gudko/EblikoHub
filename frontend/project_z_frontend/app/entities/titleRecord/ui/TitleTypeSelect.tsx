...
import { TitleType, TitleTypeOptionsColors, titleTypeOptions } from "~/entities/titleRecord/model/titleRecord";
...
const TitleTypeSelect: React.FC<TitleTypeSelectProps> = ({
    value,
    onChange,
    disabled,
    className = "",
    ...
    const triggerColorClass = value ? getTitleTypeColor(value) : "text-foreground-muted";
