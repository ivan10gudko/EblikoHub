...
export const AddNewButton = ({
  ...
  if (variant === "card") {
    return (
      <button
        onClick={onClick}
        className={cn(
          "flex flex-col min-h-40 cursor-pointer items-center justify-center gap-2 w-full bg-background-muted hover:bg-background-muted-hover border-2 border-dashed border-border hover:border-primary rounded-2xl transition-all duration-200",
          className
        )}
      >
  ...
  return (
    <Button
      ...
      onClick={onClick}
      className={cn(
        "group flex cursor-pointer items-center justify-center gap-3 w-full py-3 bg-background-muted hover:bg-background-muted-hover border-2 border-dashed border-border hover:border-primary rounded-2xl transition-all duration-200",
        className
      )}
    >
