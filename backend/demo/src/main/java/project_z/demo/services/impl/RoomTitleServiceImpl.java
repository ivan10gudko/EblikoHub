...
public class RoomTitleServiceImpl implements RoomTitleService {
    ...
    @Override
    @Transactional
    public RoomTitleDetailsDto create(RoomTitleCreateDto dto) {
        RoomTitleEntity entity = new RoomTitleEntity();
    ...
    public RoomTitleDetailsDto findById(UUID id) {
        return repository.findById(id)
                .map(mapper::mapTo)
                .orElseThrow(() -> new RuntimeException("Room Title not found"));
    }
