ALTER TABLE rooms ADD COLUMN description VARCHAR(255);
...
CREATE INDEX idx_room_titles_room_id ON room_titles(room_id);
CREATE INDEX idx_room_title_links_room_title_id ON room_title_links(room_title_id);
